...
$path='../themes/upload/faculty/';$w=200;$h=200; ?>
...
<tr>
  ...
  <td><select name="msg_menu_id"<?php if(isset($q_ed)){?> title="<?=$q_ed->msg_menu_id?>"<?php }?> >
          <?php $fuqw=mysql_query("select * from  sy_menu where menu_cat_type=9 order by menu_nm"); while($rty=mysql_fetch_object($fuqw)){?>
